...
public class ThiriaSolverSettings
{
    ...
    public bool Draw()
    {
        ...
        if (P.PluginUi.ExpertSettingsUI.expertIcon != null)
        {
            ImGui.TextWrapped($"This solver only applies to recipes with the");
            ImGui.SameLine();
            ImGui.Image(P.PluginUi.ExpertSettingsUI.expertIcon.Handle, P.PluginUi.ExpertSettingsUI.expertIcon.Size, new Vector2(0, 0), new Vector2(1, 1), new Vector4(0.94f, 0.57f, 0f, 1f));
            ImGui.SameLine();
